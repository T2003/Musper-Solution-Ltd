  ...
  return (
    <div>
      <HeroSection
        ...
        secondaryButtonLink="mailto:muspersolutions@gmail.com"
      />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-[#134B42]/5 p-8 rounded-lg text-center">
              ...
              <h3 className="text-xl font-bold text-[#134B42] mb-2">Location</h3>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <SectionHeader title="Visit Our Office" subtitle="We're located in the heart of Kigali, Rwanda." />
      ...
      <section className="py-20 bg-[#134B42]/5">
        <div className="container mx-auto px-4">
          <SectionHeader title="Business Hours" subtitle="Our team is available during the following hours." />

          <div className="max-w-2xl mx-auto">
            <div className="bg-white p-8 rounded-lg">
              <div className="grid grid-cols-2 gap-4">
                <div className="border-b pb-2">
                  <p className="font-semibold text-[#134B42]">Monday - Friday</p>
                </div>
                <div className="border-b pb-2">
                  <p>9:00 AM - 5:00 PM</p>
                </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-gray-700">
                  Need to meet outside of regular business hours? Contact us to arrange a special appointment.
                </p>
              </div>
            </div>
          </div>

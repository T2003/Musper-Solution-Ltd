      ...
      <div className='container mx-auto px-4'>
        <div className='flex items-center justify-between h-20'>
          <Link href='/' className='flex items-center gap-2'>
            ...
            />
            {/* <span className='text-xl font-bold text-[#134B42]'>
              Musper Solutions
            </span> */}
          </Link>
          ...
          <nav className='hidden md:flex items-center gap-8'>
            <Link
              href='/'
              className='text-gray-700 hover:text-[#134B42] font-medium'
            >
              Home
            </Link>
            <Link
          ...
          <div className='hidden md:flex items-center gap-4'>
            ...
            <Link
              href='https://www.linkedin.com/in/musper-solutions'
              target='_blank'
              rel='noopener noreferrer'
            >
            ...
            <Link
              href='/contact'
              className='bg-[#134B42] hover:bg-[#134B42]/90 text-white px-4 py-2 rounded-md'
            >
              Get Started
            </Link>
          </div>
          ...
          <div className='container mx-auto px-4 py-4'>
            <nav className='flex flex-col gap-4'>
              ...
              <div className='flex gap-4 mt-4'>
                ...
                <Link
                  href='ww.linkedin.com/in/musper-solutions'
                  target='_blank'
                  rel='noopener noreferrer'
                >
                  <Linkedin className='w-5 h-5 text-gray-600 hover:text-[#134B42]' />
